...
interface CourseContextOptionInterface {
    id: number;
    workspace: string;
...
const CourseContextOption: React.FC<CourseContextOptionInterface> = ({
    id,
    workspace,
    dispatch,
    canRemove,
    ...
    const handleRemoveCourse = () => {
        return removeCourse(dispatch, workspace, id);
    };

    const history = useHistory();
    const MenuList = [
        {
            name: translator('COURSES.PREVIEW'),
            icons: <EyeIcon className={iconStyle} />,
            isDisplay: true,
        },
        {
            name: translator('COURSES.EDIT'),
            icons: <PencilIcon className={iconStyle} />,
            function: () =>
                history.push(`/workspace/${workspace}/course/${id}`),
            isDisplay: true,
        },
        // {
        //     name: 'Duplicate',
        ...
        // },
        {
            name: translator('COURSES.DELETE'),
...
export default CourseContextOption;
