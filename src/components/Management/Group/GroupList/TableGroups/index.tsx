        ...
        () => [
            {
                Header: ({
                    ...
                    <div className="flex items-center justify-between border-r border-ooolab_bar_color py-ooolab_p_2">
                        <IndeterminateCheckbox
                            {...getToggleAllRowsSelectedProps()}
                        />
                        <RenderGroupsHeader value="Group Id" />
                        <span></span>
                        <span></span>
                        <span></span>
                    </div>
                ...
                Cell: ({ row }: { row: Row }) => (
                    <div className="border-r border-ooolab_bar_color flex items-center justify-between h-full py-ooolab_p_4 font-normal">
                        ...
                        />
                        <Link
                            to={`/workspace/${param.id}/management/groups/${row.values.id}`}
            ...
            },
            {
                Header: () => (
                    <div className="h-full flex items-center">
                        <RenderGroupsHeader value="Location" />
                    </div>
                ),
                accessor: 'location',
                Cell: ({ row }: { row: Row }) => (
            ...
            // {
            //     Header: () => (
            //         <p className="py-ooolab_p_2 h-full cursor-default">
            //             Created
            //         </p>
            //     ),
            //     accessor: 'created',
