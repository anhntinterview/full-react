        ...
        <form className="px-ooolab_p_5">
            <div className="border-b border-ooolab_bar_color px-ooolab_p_5 py-ooolab_p_5 flex items-center justify-between">
                <div className="relative overflow-hidden w-ooolab_w_25 h-ooolab_h_25 rounded-full border border-ooolab_bar_color group hover:border-black">
                    <img className="w-full h-full z-1 absolute left-0" src={WorkspaceAvatar} alt="group-avatar" />
                    <button type="button" className="z-30 w-ooolab_w_25 h-ooolab_h_25 bg-ooolab_dark_50 bg-opacity-60 rounded-full border-ooolab_bar_color -left-full absolute group-hover:left-0">
                        <span className="text-ooolab_10px bg-ooolab_light_100 p-ooolab_p_1">Change Avatar</span>
                    </button>
                </div>
            ...
            <div className="p-ooolab_p_5 grid grid-cols-3 gap-x-ooolab_w_8 gap-y-ooolab_w_5">
                ...
                <div className="col-span-1 text-ooolab_xs">
                    ...
                    <input
                        className="border lg:w-1/2 md:w-3/4 w-1/2 border-ooolab_bar_color text-ooolab_dark_1 p-ooolab_p_2 rounded font-normal"
                        type="text"
                        id="group-status"
                        placeholder="Status"
                        {...register('status')}
