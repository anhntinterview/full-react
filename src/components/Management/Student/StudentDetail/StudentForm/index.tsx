    ...
    return (
        <form className="px-ooolab_p_5">
            <div className="border-b border-ooolab_bar_color px-ooolab_p_5 py-ooolab_p_5 flex items-center justify-between">
                <div className="relative overflow-hidden w-ooolab_w_25 h-ooolab_h_25 rounded-full border border-ooolab_bar_color student hover:border-black">
                    <img
                    ...
                    <button
                        type="button"
                        className="z-30 w-ooolab_w_25 h-ooolab_h_25 bg-ooolab_dark_50 bg-opacity-60 rounded-full border-ooolab_bar_color -left-full absolute student-hover:left-0"
                    >
